...
class WorkflowIR:
    ...
    def get_entry_nodes(self) -> List[IRNode]:
        ...
        return [n for n in self.nodes if n.id not in nodes_with_flow_in
                and n.kind not in (NodeKind.COMPARISON, NodeKind.END)]
    ...
    def to_dict(self) -> dict:
        ...
        if self.layered_contracts is not None:
            payload["layered_contracts"] = self.layered_contracts
        return payload
    ...
    def from_dict(cls, d: dict) -> 'WorkflowIR':
        ...
        return cls(
            ...
            layered_contracts=d.get("layered_contracts"),
        )
