...
class MainZonePanel(QWidget):
    ...
    def _resolve_system_icon_path(self, key: str, fallback_rel_path: str) -> Path:
        rel_or_abs = str(self.config.get("UI", key, fallback=fallback_rel_path, config_type="system") or "").strip()
        if not rel_or_abs:
