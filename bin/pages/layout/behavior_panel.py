...
if TYPE_CHECKING:
    from src.system.behavior.timeline_view_model import TimelineSelection, SelectionLevel
...
from src.system.behavior.action_profile import (
    ActionMotorOverlay,
    ActionSegment,
    BehaviorTimeline,
    MotorSegment,
...
from src.system.behavior.timeline_migration import migrate_timeline
...
from src.system.behavior.hb_channel import (
    HBCompileRequest,
...
from src.system.behavior.hb_node_catalog import HBNodeAvailability, HBNodeCatalog
from src.system.behavior.hb_compat_audit import (
    HBCompatReport,
    audit_catalog_compatibility,
    audit_action_compatibility,
)
from src.system.behavior.hb_display_state import (
...
from bin.pages.settings.motor_weight_navigator import MotorWeightNavigator  # Step 2
from src.system.behavior.motor_param_source import (                         # Step 3
    STRUCTURAL_KEYS,
    get_param_source,
)
...
class TimelineView(QGraphicsView):
    ...
    def set_multi_track_timeline(
        ...
        if brand or robot_type:
            try:
                from src.system.behavior.timeline_view_model import build_timeline_view_model
            ...
            for item in items:
                ...
                if item.data(1) == "body_part_module":
                    ...
                    if self._timeline_vm is not None:
                        from src.system.behavior.timeline_view_model import TimelineSelection
...
class BehaviorPanel(QWidget):
    ...
    def _refresh_navigator(self) -> None:
        ...
        try:
            from src.system.behavior.action_profile import get_motor_track_map
    ...
    def set_capability_profile(self, cap: Dict[str, Any]) -> None:
        ...
        if model_switched and self._behavior_timeline is not None:
            try:
                from src.system.behavior.timeline_migration import (
    ...
    def _render_body_part_settings(self, limb_id: str, action_id: Optional[str] = None) -> None:
        ...
        """
        from src.system.behavior.motor_topology import resolve_topology
