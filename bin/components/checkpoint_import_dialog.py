...
class CheckpointImportDialog(QDialog):
    """
    Modal dialog for importing a checkpoint bundle into ``custom_checkpoints/``.
    ...
    def _on_hf_url_changed(self, text: str) -> None:
        ...
        try:
            from system.training.hf_downloader import parse_hf_url
    ...
    def _on_hf_download(self) -> None:
        ...
        from bin.core.hf_download_thread import HFDownloadThread
