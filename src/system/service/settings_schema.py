...
from src.system.models.model_registry import canonical_brand_ids, get_model_ids
...
#
# Sourced from README section 8.4 (brand = "boston_dynamics").
...
def get_settings_schema(brand: str) -> Dict[str, Dict[str, Any]]:
    ...
    Args:
        brand: Brand key string - one of ``KNOWN_BRANDS``
               (``"unitree"``, ``"boston_dynamics"``, ``"xiaomi"``).
