...
from src.system.compiler.ir.workflow_ir import WorkflowIR, IRNode, IREdge, NodeKind, EdgeType
from src.system.compiler.schema.registry import SchemaRegistry
...
class IRToCode:
    ...
    def _gen_protocol_emit(self, node: "IRNode", indent: int) -> List[str]:
        ...
        lines.append(
            f"{indent_str}from src.system.compiler.lowering.protocol_compiler import ProtocolPayloadCompiler"
        )
