...
from src.system.compiler.semantic.diagnostics import Diagnostic, make_error, make_warning
from src.system.models.model_registry import get_robot_brand_map, normalize_brand_id
