...
# Existing code may continue to import from here; new code should prefer
# ``from src.system.skill import SkillManifest`` directly.
# ---------------------------------------------------------------------------
...
from src.system.skill.manifest_loader import load_skill_manifest  # noqa: F401
