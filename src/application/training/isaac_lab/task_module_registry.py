...
IL_REWARD_REGISTRY: Dict[str, TaskModuleItem] = {
    ...
    "termination_penalty": _reward_item(
        ...
        default=-200.0, min_value=-1000.0, max_value=0.0, step=1.0,
        applicable_families=_LOCOMOTION_FAMILIES,
        backends=_IL, algorithms=frozenset({ALG_ALL}),
        il_func="_unitport_is_terminated", il_module=IL_MOD_INLINE,
        il_inline=_INLINE_IS_TERMINATED,
    ),
