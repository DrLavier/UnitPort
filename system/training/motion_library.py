...
Directory layout (under <project_root>/custom_motions/):
...
from system.training.robot_family import ROBOT_FAMILY_BY_TYPE, normalize_robot_type
...
CUSTOM_MOTIONS_DIR: Path = _PROJECT_ROOT / "custom_motions"
