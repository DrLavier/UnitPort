...
#                          + command(4) + previous_action(12) = 46
#                          (plan document labels this "45-d"; kept as 45 to
#                          stay compatible with existing manifest files that
#                          were written with obs_dim=45)
...
_CONTRACTS: Dict[str, dict] = {
    PRESET_UNITPORT_GO2_V1: {
        ...
        "description": "UnitPort Go2 default — 45-d (joint_pos×12 + joint_vel×12 "
                       "+ imu×6 + command×4 + previous_action×12)",
    },
    PRESET_COMMUNITY_GO2_SAC_34D: {
        "obs_components": [
