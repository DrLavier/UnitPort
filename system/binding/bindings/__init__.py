"""system.binding.bindings — concrete ActionBinding implementations.

Importing this package registers all built-in bindings into
``system.binding.registry.default_registry`` at import time.
...
from system.binding.bindings.locomotion import ForwardBinding
from system.binding.registry import default_registry
